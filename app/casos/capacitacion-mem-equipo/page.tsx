...
export default function Caso3Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="text-3xl font-bold text-gray-900">
        Capacitación MEM y toma de decisiones para equipo directivo
      </h1>
      <p className="mt-4 text-gray-600">
        Placeholder del caso: programa, objetivos, temario y resultados.
      </p>
