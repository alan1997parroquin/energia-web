// app/servicios/capacitacion/riesgos/page.tsx
import Link from "next/link";
import Image from "next/image";

const modules = [
  { title: "Mapa de riesgos", desc: "Riesgos regulatorios, técnicos, operativos y de mercado: cómo se identifican y priorizan." },
  { title: "Oportunidades", desc: "Dónde suelen aparecer ahorros y mejoras: estrategia, operación, tarifas, consumo y contratos." },
  { title: "Mitigación", desc: "Controles, políticas, coberturas y decisiones que reducen exposición y sorpresas." },
  { title: "Casos reales", desc: "Ejemplos típicos y lecciones aprendidas para acelerar decisiones con menos incertidumbre." },
];
        ...
        <section className="mt-8 grid items-start gap-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 max-w-2xl text-base text-ink-muted">
              Identifica y reduce incertidumbre: entendemos los principales riesgos del sector eléctrico y
              las oportunidades que suelen generar ahorros y ventajas competitivas.
            </p>
          ...
          <div className="lg:col-span-5">
            <div className="relative overflow-hidden rounded-3xl border border-surface-border bg-white/75 shadow-sm backdrop-blur">
              <div className="relative h-52 w-full sm:h-64">
                <Image
                  src="/imagen/capacitacion/riesgos1.jpg"
                  alt="Capacitación: Riesgos y oportunidades"
                  fill
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-ink-muted">
                Ideal para equipos directivos, comerciales y técnicos que necesitan claridad para decidir.
              </p>
            </div>
