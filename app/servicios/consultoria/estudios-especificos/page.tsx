...
export const metadata: Metadata = {
  title: "Estudios específicos | Consultoría MEM y migración",
  description:
    "Optimizamos tu estrategia en el Mercado Eléctrico Mayorista. Análisis de contratos de cobertura, consumo de energía y asesoría para migración al MEM con datos reales.",
  keywords: [
    "MEM",
    "demanda electrica",
    ...
    "interconexión",
    "análisis de contratos de cobertura",
    "análisis de consumo",
    "migración a MEM",
  ],
  alternates: { canonical: "/servicios/consultoria/estudios-especificos" },
  openGraph: {
    title: "Estudios específicos | Energía México",
    description:
      "Análisis de mercado, contratos de cobertura, consumo y migración al MEM para decisiones energéticas con sustento técnico.",
    url: "/servicios/consultoria/estudios-especificos",
    type: "website",
  },
};
...
const subservices = [
  {
    id: "analisis-de-mercado-electrico-mayorista",
    title: "Análisis de Mercado Eléctrico Mayorista (MEM)",
  ...
  {
    id: "investigacion-especifica-cualquier-cosa-no-listada",
  ...
  {
    id: "analisis-de-contrato-de-cobertura-electrica",
  ...
  {
    id: "asesoria-de-migracion-a-mem",
          ...
          <div className="mt-6 grid items-start gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)] lg:gap-12">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base text-ink-muted">
                Transformamos la complejidad técnica del sector energético en
                activos estratégicos para tu empresa. Ofrecemos estudios
                puntuales analizando los componentes críticos (técnicos,
                económicos y regulatorios) para responder a las preguntas
                específicas de tu negocio. A diferencia de un análisis
                superficial, realizamos un estudio de cobertura y consumo
                profundo del{" "}
                <span className="font-semibold text-brand-green">
                  Mercado Eléctrico Mayorista
                </span>
                . Esto nos permite diseñar la estrategia de suministro y el
                modelo de cobertura idóneo que el perfil de consumo de energía
                de tu proyecto requiere para maximizar su rentabilidad.
              </p>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-bold tracking-tight text-ink">
                Conoce nuestros servicios en estudios de especialidad
              </h2>
              <p className="mt-2 max-w-2xl text-sm text-ink-muted">
                Cada subservicio incluye problema y solución para ayudarte a
                responder preguntas específicas con una base técnica sólida.
              </p>
            </div>
          </div>
