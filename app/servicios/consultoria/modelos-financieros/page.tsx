...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Modelado Matemático de Sistemas Eléctricos y Modelos Financieros | Energía México",
    description:
      "Optimizamos tu inversión con el modelado matemático de sistemas eléctricos. Modelos financieros basados en simulaciones de despacho y precios reales del MEM.",
          ...
          <div className="mt-6 grid items-start gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)] lg:gap-12">
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base text-ink-muted">
                ...
                robusto que actúa como el motor de tu estrategia financiera. Al
                entender{" "}
                <span className="font-semibold text-brand-green">
                  qué es un modelo matemático
                </span>{" "}
                aplicado a la energía, integramos variables críticas como
                predicciones de precios y despacho real. Existen diversos tipos
                de{" "}
                <span className="font-semibold text-brand-green">
                  modelos matemáticos
                </span>
                , pero nuestra especialidad es el modelado matemático de{" "}
                <span className="font-semibold text-brand-green">
                  sistemas eléctricos
                </span>
                , transformando datos complejos en ejemplos de{" "}
                <span className="font-semibold text-brand-green">
                  modelos financieros
                </span>{" "}
                que reflejan con exactitud la rentabilidad de tus activos en
                México.
              </p>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-bold tracking-tight text-ink">
                Conoce nuestros servicios en modelos matemáticos
              </h2>
              <p className="mt-2 max-w-2xl text-sm text-ink-muted">
                El problema y la solución aplican a ambos subservicios. Las
                descripciones son propuestas iniciales y se pueden ajustar.
              </p>
            </div>
          </div>
