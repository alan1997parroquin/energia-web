// app/servicios/fotovoltaico/mantenimiento/page.tsx
    ...
    <main className="relative isolate overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-32 pb-16 lg:pt-24">
        <div className="flex flex-wrap items-center gap-2 text-sm">
          ...
          <span className="text-ink-soft">/</span>
          <span className="font-semibold text-ink">Mantenimiento</span>
        </div>
        ...
        <section className="mt-8 grid items-start gap-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 max-w-2xl text-base text-ink-muted">
              Preservamos rendimiento y vida útil: inspecciones, limpieza, termografía/diagnóstico,
              revisiones eléctricas y atención a fallas.
            </p>
            ...
            <div className="mt-6 grid max-w-2xl gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-surface-border bg-white/70 p-4 backdrop-blur">
                ...
                <p className="mt-1 text-sm text-ink">
                  La falta de mantenimiento reduce generación, acelera degradación y aumenta el riesgo de fallas y paros.
                </p>
              </div>
              <div className="rounded-2xl border border-surface-border bg-white/70 p-4 backdrop-blur">
                <p className="text-xs font-semibold uppercase tracking-wide text-ink-soft">Solución</p>
                <p className="mt-1 text-sm text-ink">
                  Programa preventivo + atención correctiva con evidencias y reportes para mantener performance estable.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative overflow-hidden rounded-3xl border border-surface-border bg-white/75 shadow-sm backdrop-blur">
              <div className="relative h-52 w-full sm:h-64">
                <Image src="/imagen/fotovoltaico/mantenimiento.jpg" alt="Mantenimiento FV" fill className="object-cover" priority />
              ...
              <div className="p-5">
                ...
                <ul className="mt-3 space-y-2 text-sm text-ink-muted">
                  <li className="flex gap-2"><span className="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-brand-green" /><span>Inspección y checklist</span></li>
                  <li className="flex gap-2"><span className="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-brand-green" /><span>Limpieza y diagnóstico</span></li>
                  <li className="flex gap-2"><span className="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-brand-green" /><span>Atención a fallas + reporte</span></li>
                </ul>
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  ...
                  <Link href="/servicios/fotovoltaico/financiamiento" className="inline-flex items-center justify-center rounded-full border border-surface-border bg-white px-4 py-2 text-sm font-semibold text-ink hover:bg-surface-soft">
                    Ver Financiamiento →
                  </Link>
                </div>
              </div>
        ...
        <section className="mt-16 border-t border-surface-border pt-12">
          <div className="rounded-3xl border border-surface-border bg-white p-8 shadow-sm">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <h2 className="text-2xl font-bold tracking-tight text-ink">Mantén el ahorro mes a mes</h2>
                <p className="mt-2 text-sm text-ink-muted">Rendimiento estable con mantenimiento bien ejecutado.</p>
              </div>
