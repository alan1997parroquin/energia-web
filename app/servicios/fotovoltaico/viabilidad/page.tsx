// app/servicios/fotovoltaico/viabilidad/page.tsx
    ...
    <main className="relative isolate overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-32 pb-16 lg:pt-24">
        ...
        <div className="flex flex-wrap items-center gap-2 text-sm">
          ...
          <Link href="/servicios/fotovoltaico" className="font-semibold text-ink hover:underline">
            Integrador Fotovoltaico
          </Link>
          <span className="text-ink-soft">/</span>
          <span className="font-semibold text-ink">Estudio de viabilidad</span>
        </div>
        ...
        <section className="mt-8 grid items-start gap-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 max-w-2xl text-base text-ink-muted">
              Determinamos si el proyecto hace sentido técnica y económicamente: consumo, espacio, restricciones,
              configuración preliminar y estimación inicial de ahorro/ROI.
            </p>
            ...
            <div className="mt-6 grid max-w-2xl gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-surface-border bg-white/70 p-4 backdrop-blur">
                ...
                <p className="mt-1 text-sm text-ink">
                  Muchas empresas invierten en propuestas sin validar restricciones del sitio, interconexión y retorno
                  realista, provocando retrabajos y decisiones con incertidumbre.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-surface-border bg-white/70 p-4 backdrop-blur">
                ...
                <p className="mt-1 text-sm text-ink">
                  Evaluación rápida con criterios técnicos y financieros para definir si conviene, bajo qué condiciones
          ...
          <div className="lg:col-span-5">
            <div className="relative overflow-hidden rounded-3xl border border-surface-border bg-white/75 shadow-sm backdrop-blur">
              <div className="relative h-52 w-full sm:h-64">
                <Image
                  src="/imagen/fotovoltaico/viabilidad.jpg"
              ...
              <div className="p-5">
                ...
                <ul className="mt-3 space-y-2 text-sm text-ink-muted">
                  <li className="flex gap-2">
                    ...
                    <span>Revisión de consumo y demanda</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-brand-green" />
                    <span>Estimación preliminar de sistema y ahorro</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-brand-green" />
                    <span>Riesgos/restricciones + siguientes pasos</span>
                  </li>
                </ul>
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <h2 className="text-2xl font-bold tracking-tight text-ink">
                  Toma la decisión con datos, no con suposiciones
                </h2>
                <p className="mt-2 text-sm text-ink-muted">
                  Validamos viabilidad técnica y económica para que inviertas con claridad.
                </p>
              </div>
