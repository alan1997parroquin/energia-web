...
- Lista de información faltante y siguientes pasos para CFE.`,
  ...
  },
  {
    ...
    problem:
      "Los cambios de titularidad suelen retrasarse por requisitos incompletos o inconsistencias en la documentación presentada.",
    solution:
      "Te ayudamos a estructurar correctamente el expediente y a gestionar el proceso para reducir fricción, tiempos muertos y correcciones innecesarias.",
  },
  {
    id: "nuevo-servicio",
    ...
    problem:
      "Solicitar un nuevo servicio sin claridad sobre requisitos técnicos, capacidad disponible o ruta documental puede alargar innecesariamente el proceso.",
    solution:
      "Te ayudamos a preparar la solicitud con orden técnico y documental para llegar a CFE con una estrategia más sólida y menos incertidumbre.",
  },
  {
    ...
    problem:
      "Muchas solicitudes de incremento de demanda avanzan sin validar previamente el impacto real en infraestructura, tiempos y posibles refuerzos.",
    solution:
      "Analizamos el contexto técnico del proyecto y estructuramos una ruta para solicitar el incremento con mayor claridad y mejor preparación.",
  },
  {
    id: "interconexion",
    ...
    problem:
      "La interconexión vinculada al suministro puede volverse compleja cuando no se identifican correctamente sus implicaciones técnicas y documentales desde el inicio.",
    solution:
      "Acompañamos el proceso para estructurar mejor la información requerida y reducir observaciones, retrasos o reprocesos con CFE.",
  },
];
          ...
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)] lg:gap-12">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base text-ink-muted">
                ...
                puede convertirse en un proceso lento y confuso: criterios técnicos,
                capacidad disponible, posibles obras y tiempos que dependen de la zona.
        ...
        <section className="mt-10">
          <div className="rounded-3xl border border-surface-border bg-white/80 p-8 shadow-sm backdrop-blur">
            ...
            <div className="mt-4 max-w-4xl space-y-4 text-sm leading-relaxed text-ink-muted">
              <p>
                Reducimos la incertidumbre de factibilidad antes de que inviertas
                tiempo y dinero en trámites formales. Muchos proyectos fallan por
                no validar a tiempo condiciones básicas como capacidad de la red local,
                nivel de tensión, necesidades de subestación o restricciones operativas.
              </p>

              <p>
                Nuestra solución: prefactibilidad rápida con información pública.
                Realizamos un estudio ágil usando información pública y criterios
                técnicos para darte una señal temprana y accionable.
              </p>

              <ul className="space-y-3 text-sm text-ink-muted">
                <li className="flex gap-3">
                  <span className="mt-0.5 flex-none text-brand-green">✔</span>
                  <span>Si el proyecto es viable en el punto propuesto, con o sin obras.</span>
                </li>

                <li className="flex gap-3">
                  <span className="mt-0.5 flex-none text-brand-green">✔</span>
                  <span>Qué nivel de tensión es el más probable, media o alta tensión.</span>
                </li>

                <li className="flex gap-3">
                  <span className="mt-0.5 flex-none text-brand-green">✔</span>
                  <span>Qué tipo de estructuras o adecuaciones podrían requerirse.</span>
                </li>

                <li className="flex gap-3">
                  <span className="mt-0.5 flex-none text-brand-green">✔</span>
                  <span>Recomendaciones para llegar a CFE con un expediente y estrategia más sólidos.</span>
                </li>

                <li className="flex gap-3">
                  <span className="mt-0.5 flex-none text-brand-green">✔</span>
                  <span>Resultado: tomas decisiones con claridad antes de iniciar la solicitud con CFE.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="subservicios" className="mt-14">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-bold tracking-tight text-ink">
                Conoce nuestros servicios de baja media y alta tensión CFE
              </h2>
            </div>
          </div>
